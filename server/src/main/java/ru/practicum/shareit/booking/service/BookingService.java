...
public interface BookingService {
    ...
    List<OutcomingBookingDto> getBookings(long userId, String state, Integer from, Integer size);

    List<OutcomingBookingDto> getBookingsForOwnedItems(long userId, String state, Integer from, Integer size);
