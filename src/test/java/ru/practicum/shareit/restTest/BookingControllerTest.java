...
class BookingControllerTest {
    ...
    private static BookingDto invalidBookingDto;
    ...
    static void setUp() {
        ...
        invalidBookingDto = new BookingDto(1L, LocalDateTime.now().minusDays(1),
                LocalDateTime.now().plusDays(2));
    ...
    void getBookings() {
        doReturn(List.of(outcomingBookingDto))
                .when(bookingService)
                .getBookings(anyLong(), any(State.class), anyInt(), anyInt());
    ...
    void getBookings_whenFailed() {
        doThrow(UnsupportedStateException.class)
                .when(bookingService)
                .getBookings(anyLong(), any(State.class), anyInt(), anyInt());
        ...
        assertEquals("Unknown state: Bad", error);
    }
    ...
    void getBookingsForOwnedItems_whenFailed() {
        doThrow(UnsupportedStateException.class)
                .when(bookingService)
                .getBookingsForOwnedItems(anyLong(), any(State.class), anyInt(), anyInt());
